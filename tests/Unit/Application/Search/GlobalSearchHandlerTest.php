...
{
    public function testShortQueryGivesEmptyGroups(): void
    {
        $handler = self::handler(new InMemoryClientRepository(), new InMemoryNoteRepository());

        $results = $handler(' а ', null);
    ...
    public function testFindsTagsWithUsageCount(): void
    {
        ...
        $results = self::handler(new InMemoryClientRepository(), new InMemoryNoteRepository(), $tags)('вок', null);
    ...
    public function testTagsAreOwnerScoped(): void
    {
        ...
        $results = self::handler(new InMemoryClientRepository(), new InMemoryNoteRepository(), $tags)('вокал', $mine);
    ...
    public function testFindsClientsByNameCaseInsensitive(): void
    {
        ...
        $results = self::handler($clients, new InMemoryNoteRepository())('скрипк', null);
    ...
    public function testArchivedClientIsFoundAndMarked(): void
    {
        ...
        $results = self::handler($clients, new InMemoryNoteRepository())('ушедшая', null);
    ...
    public function testOwnerScopeAppliesToClientsAndNotes(): void
    {
        ...
        $results = self::handler($clients, $notes)('ученик', $mine);
    ...
    public function testNoteSnippetIsCutAroundMatch(): void
    {
        ...
        $results = self::handler(new InMemoryClientRepository()->withClient(1, $client), $notes)('этюд', null);
    ...
    private static function handler(
        ...
        return new GlobalSearchHandler($clients, $notes, $tags ?? new InMemoryTagRepository());
    }
