...
final readonly class ScheduleLessonCommand
{
    public function __construct(
        #[Assert\Positive(message: 'Выберите ученика.')]
        public int $clientId,
        ...
        #[Assert\Length(max: 2000, maxMessage: 'Комментарий не может быть длиннее {{ limit }} символов.')]
