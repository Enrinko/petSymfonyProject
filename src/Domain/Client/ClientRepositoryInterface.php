...
interface ClientRepositoryInterface
{
     ...
     *
     * Дедупликация обязана уважать owner-скоуп: обычный преподаватель
     * матчит дубль только среди СВОИХ активных клиентов, иначе импорт
     * позволяет переписать чужую запись по совпадению email ($owner === null
     * — без ограничения, для модератора/админа). Архивные не матчатся.
     */
